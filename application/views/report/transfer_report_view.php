    ...
    $(document).ready(function () {
        ...
        $('#btn-search').click(function(){
            ...
            if(search == "periode"){
                ...
                location.href = "<?php echo site_url('Report/transferReportSearchByPeriode')?>/"
                +start_date.format('YYYY-MM-DD')+"/"+end_date.format('YYYY-MM-DD');
            }else if(search == "date"){
                var date = $('#search-date').data('daterangepicker').endDate;
                location.href = "<?php echo site_url('Report/transferReportSearchByDate')?>/"+date.format('YYYY-MM-DD');
            }
        });
