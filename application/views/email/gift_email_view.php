                ...
                <div class="contentEditableContainer contentTextEditable">
                    <div class="contentEditable" align='left' >
                        <p >Kepada Yth <?php echo $detail_user->name; ?>,
                            <br/>
                            Transaksi Gift Claim Anda berhasil. Berikut detail transaksi Anda</p>
                    </div>
                </div>
            </td>
            <td width="50">&nbsp;</td>
            ...
            <td width="380" align="center" style="padding-top:25px;">
                <table cellpadding="1" cellspacing="0" border="0" width="350" align="center" class="content-container">
                    <tr>
                        ...
                        <td>: <?php echo $detail_gift_claim->created ;?></td>
                    </tr>
                    <tr>
                        <td><b>Nama Gift</b></td>
                        <td>: <?php echo $detail_gift_claim->giftName ;?></td>
                    </tr>
                    <tr>
                        <td><b>Kategori Gift</b></td>
                        <td>: <?php echo $detail_gift_claim->giftCategory ;?></td>
                    </tr>
                    <tr>
                        <td><b>Reward</b></td>
                        <td>: <?php echo $detail_gift_claim->reward ;?></td>
                    </tr>
                    <tr>
                        <td><b>Poin Cost</b></td>
                        <td>: <?php echo $detail_gift_claim->poin ;?></td>
                    </tr>
                </table>
            </td>
        </tr>
