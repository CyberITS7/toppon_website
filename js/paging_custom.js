...
// Creating the sweetPages jQuery plugin:
    $.fn.sweetPages = function(opts){
        ...
        swPage.each(function(){
            ...
            var tmpHeight = 0;
            elem.find('div.panel').each(function(){tmpHeight+=$(this).data('height');});

            if(tmpHeight>maxHeight)
                maxHeight = tmpHeight;

            totalWidth+=elem.outerWidth()+3333;
        ...
        hyperLinks.click(function(e){
            ...
            swSlider.stop().animate({'margin-left':-(parseInt($(this).text())-1)*$(".x_content").outerWidth()},'slow');
            e.preventDefault();
        });
        ...
        swControls.css({
            'left':'50%',
            'margin-left':-swControls.width()/10
        });
...
$(document).ready(function(){
    ...
    $('#accordion').sweetPages({perPage:5});
